...
Public Class frm_OtherPaymentAcount
    Dim WithEvents da As New SqlDataAdapter
    Dim WithEvents dt As New DataTable
    Dim WithEvents bs As New BindingSource

    Private Sub frm_OtherPaymentAcount_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            FontMyControl(Me)
    ...
    Private Sub daInitialize()
        ...
        With da.SelectCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_OtherPaymentAcount_Select"
        ...
        With da.InsertCommand
            ...
            .Connection = PubCn
            .CommandText = "sp_tbl_OtherPaymentAcount_Insert"
            .CommandType = CommandType.StoredProcedure


            .Parameters.Clear()
            .Parameters.Add("@OtherPaymentAcountID", SqlDbType.BigInt, 0, "OtherPaymentAcountID")
            .Parameters("@OtherPaymentAcountID").Direction = ParameterDirection.Output
        ...
        With da.UpdateCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_OtherPaymentAcount_Update"
            .CommandType = CommandType.StoredProcedure
        ...
        With da.DeleteCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_OtherPaymentAcount_Delete"
            .CommandType = CommandType.StoredProcedure
    ...
    Private Sub GetDataTable()
        ...
        With dgv
            ...
            .Columns("OtherPaymentAcountID").HeaderText = "ر.م"
        ...
        Me.txtOtherPaymentAcountName.DataBindings.Clear()
        Me.txtOtherPaymentAcountName.DataBindings.Add(New System.Windows.Forms.Binding("Text", bs, "OtherPaymentAcountName", True, DataSourceUpdateMode.OnPropertyChanged))
