...
Public Class frm_ExpenseType
    Dim WithEvents da As New SqlDataAdapter
    Dim WithEvents dt As New DataTable
    Dim WithEvents bs As New BindingSource

    Private Sub frm_ExpenseType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            FontMyControl(Me)
    ...
    Private Sub daInitialize()
        ...
        With da.SelectCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_ExpenseType_Select"
        ...
        With da.InsertCommand
            ...
            .Connection = PubCn
            .CommandText = "sp_tbl_ExpenseType_Insert"
            .CommandType = CommandType.StoredProcedure


            .Parameters.Clear()
            .Parameters.Add("@ExpenseTypeID", SqlDbType.BigInt, 0, "ExpenseTypeID")
            .Parameters("@ExpenseTypeID").Direction = ParameterDirection.Output
        ...
        With da.UpdateCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_ExpenseType_Update"
            .CommandType = CommandType.StoredProcedure
        ...
        With da.DeleteCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_ExpenseType_Delete"
            .CommandType = CommandType.StoredProcedure

            .Parameters.Clear()
            .Parameters.Add("@ExpenseTypeID", SqlDbType.BigInt, 0, "@ExpenseTypeID")
            .Parameters("@ExpenseTypeID").SourceVersion = DataRowVersion.Original
            .Parameters.Add("@UserID", SqlDbType.BigInt, 0, "@UserID")
    ...
    Private Sub GetDataTable()
        ...
        With dgv
            ...
            .Columns("ExpenseTypeID").HeaderText = "ر.م"
        ...
        Me.txtExpenseType.DataBindings.Clear()
        Me.txtExpenseType.DataBindings.Add(New System.Windows.Forms.Binding("Text", bs, "ExpenseType", True, DataSourceUpdateMode.OnPropertyChanged))
