...
Public Class frm_Brand
    ...
    Private Sub frm_Brand_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            FontMyControl(Me)
    ...
    Private Sub daInitialize()
        ...
        With da.SelectCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_Brand_Select"
        ...
        With da.InsertCommand
            ...
            .Connection = PubCn
            .CommandText = "sp_tbl_Brand_Insert"
            .CommandType = CommandType.StoredProcedure


            .Parameters.Clear()
            .Parameters.Add("@BrandID", SqlDbType.BigInt, 0, "BrandID")
            .Parameters("@BrandID").Direction = ParameterDirection.Output
        ...
        With da.UpdateCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_Brand_Update"
            .CommandType = CommandType.StoredProcedure

            .Parameters.Clear()
            .Parameters.Add("@org_BrandID", SqlDbType.BigInt, 0, "BrandID")
            .Parameters("@org_BrandID").SourceVersion = DataRowVersion.Original
            .Parameters.Add("@BrandName", SqlDbType.NVarChar, 200, "BrandName")
            .Parameters.Add("@org_BrandName", SqlDbType.NVarChar, 200, "BrandName")
            .Parameters("@org_BrandName").SourceVersion = DataRowVersion.Original
            .Parameters.Add("@UserID", SqlDbType.BigInt, 0, "UserID")
        ...
        With da.DeleteCommand
            .Connection = PubCn
            .CommandText = "sp_tbl_Brand_Delete"
            .CommandType = CommandType.StoredProcedure

            .Parameters.Clear()
            .Parameters.Add("@BrandID", SqlDbType.BigInt, 0, "BrandID")
            .Parameters("@BrandID").SourceVersion = DataRowVersion.Original
    ...
    Private Sub GetDataTable()
        ...
        With dgv
            ...
            .Columns("BrandID").HeaderText = "ر.م"
        ...
        Me.txtBrandName.DataBindings.Clear()
        Me.txtBrandName.DataBindings.Add(New System.Windows.Forms.Binding("Text", bs, "BrandName", True, DataSourceUpdateMode.OnPropertyChanged))
