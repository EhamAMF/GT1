'frm_sp_rpt_ExpenseLog
Imports System.Data.SqlClient
Imports Microsoft.Reporting.WinForms
Imports ByteClassLibrary.MyFunctions
'Form_temp
Public Class frm_sp_rpt_ExpenseLog
    ...
    Private Sub frm_sp_rpt_ExpenseLog_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If bw1.IsBusy = True AndAlso bw1.CancellationPending = False Then
            bw1.CancelAsync()
        End If
    End Sub
    Private Sub frm_sp_rpt_ExpenseLog_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            FontMyControl(Me)
...
#Region "       Subs and Functions"
    ...
    Private Function fn_sp_rpt_ExpenseLog(ByRef ExpenseTypeID As Object, ByRef DateFrom As Object, ByRef DateTo As Object, ByRef ExpenseTypeName As Object) As DataTable

        Dim da As New SqlDataAdapter("sp_rpt_ExpenseLog", PubCn)
        Dim dt As New DataTable
...
#Region "       Events"
    ...
    Private Sub frm_sp_rpt_ExpenseLog_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub bw1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bw1.DoWork
        ...
        Try
            ...
            MyTable1 = fn_sp_rpt_ExpenseLog(ExpenseTypeID, DateFrom, DateTo, ExpenseTypeName)
        ...
        Try
            ...
            If IsBW1Canseled = False Then
                If req = RequestType.dgv Then
                    ...
                    dgv.Columns("ExpenseDate").HeaderText = "التاريخ"
                    dgv.Columns("ExpenseCost").HeaderText = "القيمة"
                    dgv.Columns("Note").HeaderText = "ملاحظة"
                    dgv.Columns("UserID").HeaderText = "المستخدم"
                ...
                Else
                    ...
                    ReportDataSource.Name = "sp_rpt_ExpenseLog"
                    ReportDataSource.Value = MyTable1

                    Dim frm As New frmReportViewer

                    With frm.rvReport
                        .LocalReport.ReportEmbeddedResource = My.Application.Info.AssemblyName & ".rpt_sp_rpt_ExpenseLog.rdlc"
