'frm_sp_rpt_InvoicesRev
Imports System.Data.SqlClient
Imports Microsoft.Reporting.WinForms
Imports ByteClassLibrary.MyFunctions
'Form_temp
Public Class frm_sp_rpt_InvoicesRev
    ...
    Private Sub frm_sp_rpt_InvoicesRev_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If bw1.IsBusy = True AndAlso bw1.CancellationPending = False Then
            bw1.CancelAsync()
        End If
    End Sub
    Private Sub frm_sp_rpt_InvoicesRev_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            FontMyControl(Me)
...
#Region "       Subs and Functions"
    ...
    Private Function fn_sp_rpt_InvoicesRev(ByRef AgentID As Object, ByRef DateFrom As Object, ByRef DateTo As Object, ByRef AgentName As Object) As DataTable

        Dim da As New SqlDataAdapter("sp_rpt_InvoicesRev", PubCn)
        Dim dt As New DataTable
...
#Region "       Events"
    ...
    Private Sub frm_sp_rpt_InvoicesRev_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub bw1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bw1.DoWork
        ...
        Try
            ...
            MyTable1 = fn_sp_rpt_InvoicesRev(AgentID, DateFrom, DateTo, AgentName)
        ...
        Try
            ...
            If IsBW1Canseled = False Then
                If req = RequestType.dgv Then
                    ...
                    dgv.Columns("FinalPrice").HeaderText = "صافي الفاتورة"
                ...
                Else
                    ...
                    ReportDataSource.Name = "sp_rpt_InvoicesRev"
                    ReportDataSource.Value = MyTable1

                    Dim frm As New frmReportViewer

                    With frm.rvReport
                        .LocalReport.ReportEmbeddedResource = My.Application.Info.AssemblyName & ".rpt_sp_rpt_InvoicesRev.rdlc"
